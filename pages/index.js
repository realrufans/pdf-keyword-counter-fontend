...
export default function Home() {
  ...
  return (
    <>
      <main className="relative flex p-5 min-h-screen flex-col items-center justify-center">
        {/* <Link
        ...
        <div className="bg-gradient-to-br from-black to-[#575757] text-center text-4xl font-medium text-transparent bg-clip-text md:text-7xl pt-4 pb-8">
          <h1>PDF Phrase Counter</h1>
        </div>
        <p className="text-center">
          Determine the number of times your keywords appear in a PDF document.
        </p>
